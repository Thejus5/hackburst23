    ...
    <FullPageModal header="How to play" open={open} closeModal={closeModal}>
      <HowToPlayWrapper>
        <p>
          ...
          chest of Rs.5,000 inside the cave for you and a grand puzzle to win a
          grand prize. But I want to ensure that it’s not an easy access. You
          must work hard and earn it.
          <br />
          ...
          reward chest within 12 hours to claim the prize worth of Rs.5,000. The
          chest is locked with a 10-letter secret word. You will have to
          discover that secret word by solving some puzzles. I have already set
          up the puzzles. Go ahead and explore!
        ...
        <p>
          ...
          provided with all codes, prompts etc used to build the solution. Add a
          demo video/screenshots if possible as well.
          <br />
          ...
          puzzle by visiting the API endpoint /p/[Qn Id]. The questions will be
          unlocked at different times and will be shown in the website.
          <br />
          <br /> Step 2: Solving Treasure Hunt Puzzles Submit your answers for
          each treasure hunt question using the API endpoint /a/[Qn Id]. If your
          answer is correct, you will get 2 letters of the secret word.
          <br />
          <br /> Step 3: In case you need help solving the puzzle, Kairo will
          give you a wish. Unlock a hint using the API endpoint /p/[Qn Id]/hint
          Please note that using hints will reduce your points for that
          particular question.
          <br />
          ...
          5000, by posting them to the API /unlock/ Upload all answer-related
          documents and screenshots to the provided repository for evaluation.
          Important Tips: Ensure timely participation to unlock treasure hunt
          questions within the 12-hour period. Double-check your answers before
          submission. Each retry will cost you points. Submit answers and any
          code, file or screenshots related to the question should be added in
          repo for further evaluation. By following these steps, participants
          can navigate through the main puzzle and treasure hunt, maximizing
          their chances of winning cash prizes in the "Hackburst 23" hackathon
          event.
          <br />
        </p>
      </HowToPlayWrapper>
